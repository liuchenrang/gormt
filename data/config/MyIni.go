...
type Config struct {
	...
	IsSoftDeleteEnabled     bool              `yaml:"is_soft_delete_enabled"`       //多个文件时，是否采用驼峰或下划线
	SoftDeleteFileName      string            `yaml:"soft_delete_field"`            //多个文件时，是否采用驼峰或下划线
	HookBeforeSave          map[string]string `yaml:"hook_before_save"`             //多个文件时，是否采用驼峰或下划线
	HookBeforeCreate        map[string]string `yaml:"hook_before_create"`           //多个文件时，是否采用驼峰或下划线
}
...
func getSoftDeleteFileName() string {
	return _map.SoftDeleteFileName
}
...
func IsSoftDeleteEnabled() bool {
	return _map.IsSoftDeleteEnabled
}
func GetSoftDeleteFieldName() string {
	return _map.SoftDeleteFileName

}
func GetHookBeforeSave() map[string]string {
	return _map.HookBeforeSave
}
func GetHookBeforeCreate() map[string]string {
	return _map.HookBeforeCreate
}
